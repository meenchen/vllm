...
SKIP_N=${SKIP_N:-128}
CASES=${CASES:-"bf16 fp8 default_nvfp4 four_over_six \
skip_first_${SKIP_N} skip_last_${SKIP_N} \
skip_first_${SKIP_N}_four_over_six skip_last_${SKIP_N}_four_over_six"}
