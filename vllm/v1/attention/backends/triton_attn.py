...
class TritonAttentionImpl(AttentionImpl):
    ...
    def __init__(
        ...
        self._native_mixed_xqa_enabled = (
            self._is_fp8_k_nvfp4_v
            and envs.VLLM_FP8_K_NVFP4_V_NATIVE_DECODE
        ...
        if self._native_mixed_xqa_enabled:
    ...
    def forward(
        ...
        if self._is_fp8_k_nvfp4_v:
            ...
            key_cache, value_cache, nvfp4_v_scale_cache = (
                fp8_k_nvfp4_v_cache_split_views(packed_cache, self.head_size)
            )
            use_native_decode = (
                self._native_mixed_xqa_enabled
            ...
            if use_native_decode:
                logger.info_once(
                    "Using the FlashInfer XQA FP8-K/NVFP4-V decode kernel."
                )
